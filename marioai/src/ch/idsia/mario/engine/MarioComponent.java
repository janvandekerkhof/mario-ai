...
//=========
        ...
        evaluationInfo.marioEndingYPosition = mario.y;
...
//        evaluationInfo.Memo = "Number of attempt: " + Mario.numberOfAttempts;
    ...
    public void startLevel(Level level, int timeLimit){
        scene = new LevelScene(graphicsConfiguration, this, level, timeLimit);
